...
const int relayPin[4]={13,10,9,8}; //pin 6 drives first relay, ie one nearest to Gnd wire
const int switchPin[4]={0,1,6,7}; // Top most button mapped to digitalPin 9
